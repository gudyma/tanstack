        ...
        MonthCaption: ({ calendarMonth }) => {
          return (
            <div className="inline-flex gap-2">
              ...
              >
                <SelectTrigger className="w-fit gap-1 border-none bg-none p-0 shadow-none">
                  <SelectValue />
                </SelectTrigger>
  ...
  (
    ...
    const initHourFormat = {
      hour24:
        ...
        `dd.MM.yy HH:mm${!granularity || granularity === "second" ? ":ss" : ""}`,
      hour12:
        displayFormat?.hour12 ??
        `dd.MM.yy hh:mm${!granularity || granularity === "second" ? ":ss" : ""} b`,
    };
